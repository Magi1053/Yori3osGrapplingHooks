...
public class ClientSender {
    ...
    public static void jumpFromHook(boolean cancelUsing) {
        ...
        PlatformNetworkHelper.sendToServer(ResourceLocation.fromNamespaceAndPath("yo_hooks", "player_jump"), originalBuf);*/
    ...
    public static void climb(boolean up, int agility_level, boolean shouldPlaySound) {
        ...
        PlatformNetworkHelper.sendToServer(ResourceLocation.fromNamespaceAndPath("yo_hooks", "climb"), originalBuf); */
